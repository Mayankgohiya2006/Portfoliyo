...
const ProjectShow = (props) => {
  ...
  return (
   <div className="group section8 w-full md:w-[90vw] lg:w-[45vw] 
  ...
  <div className="flex flex-col md:flex-row md:justify-between 
    ...
    <h1 className="text-white text-xl md:text-2xl lg:text-3xl font3 
    ...
    <h1 className="text-orange-500 text-lg md:text-xl font3 
                   opacity-100 lg:opacity-0 
                   lg:group-hover:opacity-100 
                   lg:group-hover:-translate-y-3 transition">
      {props.project.desc}
